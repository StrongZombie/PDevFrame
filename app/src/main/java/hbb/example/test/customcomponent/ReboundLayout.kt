...
class ReboundLayout : LinearLayout {
    ...
    fun setBoundType(headerType:Int,bottomType:Int){
        if (headerType == ReboundUtil.HEADER_REBOUND_LIMIT && bottomType == ReboundUtil.BOTTOM_REBOUND_LIMIT){
            headerBoundType = ReboundUtil.HEADER_REBOUND_LIMIT
            bottomBoundType = ReboundUtil.BOTTOM_REBOUND_LIMIT
        }else{
            headerBoundType = ReboundUtil.HEADER_REBOUND_NORMAL
            bottomBoundType = ReboundUtil.BOTTOM_REBOUND_NORMAL
        }
    }
