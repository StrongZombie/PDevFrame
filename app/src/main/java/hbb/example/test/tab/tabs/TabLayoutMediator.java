 ...
 * TabLayoutMediator.TabConfigurationStrategy} in which you set the text of the tab, and/or perform any styling of the
...
public final class TabLayoutMediator {
    ...
    @Nullable private TabLayoutMediator.TabLayoutOnPageChangeCallback onPageChangeCallback;
    ...
    public void attach() {
        ...
        onPageChangeCallback = new TabLayoutMediator.TabLayoutOnPageChangeCallback(tabLayout);
        viewPager.registerOnPageChangeCallback(onPageChangeCallback);

        // Now we'll add a tab selected listener to set ViewPager's current item
        onTabSelectedListener = new TabLayoutMediator.ViewPagerOnTabSelectedListener(viewPager);
